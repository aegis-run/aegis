...
const (
	Schema_Read_FullMethodName  = "/aegis.schema.v1.Schema/Read"
	Schema_Write_FullMethodName = "/aegis.schema.v1.Schema/Write"
)
...
//
// Schema service provides an API for managing Aegis schemas.
type SchemaClient interface {
	// Read reads the latest schema or a specific schema version. Accepts a consistency
	// requirement to bound the read to a specific revision.
	Read(ctx context.Context, in *ReadRequest, opts ...grpc.CallOption) (*ReadResponse, error)
	// Write writes a new schema version using the compiled IR data.
...
func (c *schemaClient) Read(ctx context.Context, in *ReadRequest, opts ...grpc.CallOption) (*ReadResponse, error) {
...
func (c *schemaClient) Write(ctx context.Context, in *WriteRequest, opts ...grpc.CallOption) (*WriteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// All implementations should embed UnimplementedSchemaServer
...
// UnimplementedSchemaServer should be embedded to have
...
func (UnimplementedSchemaServer) Read(context.Context, *ReadRequest) (*ReadResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Read not implemented")
}
func (UnimplementedSchemaServer) Write(context.Context, *WriteRequest) (*WriteResponse, error) {
...
func RegisterSchemaServer(s grpc.ServiceRegistrar, srv SchemaServer) {
	// If the following call panics, it indicates UnimplementedSchemaServer was
...
func _Schema_Read_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SchemaServer).Read(ctx, req.(*ReadRequest))
	}
...
func _Schema_Write_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SchemaServer).Write(ctx, req.(*WriteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Schema_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "aegis.schema.v1.Schema",
	...
	Metadata: "aegis/schema/v1/api.proto",
}
