...
var opsLatency = telemetry.MustHistogram(
	internal.Meter,
	"aegis.database.operations.latency",
	metric.WithUnit("ms"),
	metric.WithDescription(
		"Histogram of database operation latencies in milliseconds.",
	),
...
var opsTotal = telemetry.MustCounter(
	internal.Meter,
	"aegis.database.operations.total",
	metric.WithDescription("Total number of database operations processed."),
)

var errsTotal = telemetry.MustCounter(
	internal.Meter,
	"aegis.database.errors.total",
